var Draw = function(canvas,extent) {
	var xmin = extent[0][0]||13426192.883026948;
	var ymin = extent[0][1]||3671416.5248470777;
	var xmax = extent[1][0]||13430755.218152719;
	var ymax = extent[1][1]||3674282.9134077714;
	 ...
	 * 路段起始端的像素坐标
	 */
		this.getLinePs=function(extent,scale){
	        var convert=new Convert(extent,scale);
	        var LinePs=[];
